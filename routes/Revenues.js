...
router.get('/RevenueDICIEMBRE', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{
  ...
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "DICIEMBRE" AND Activada = "Activada" AND Year(Fecha) = 2024;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueDICIEMBRE', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Octubre*/
 router.get('/editRevDec/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevDec', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevDec', (req, res) => {
  const SaleId = req.body.SaleId;
...
console.log(data)
  conexion.query('UPDATE VentasMovil SET ? WHERE SaleId = ?', [data, SaleId], (error, results) => {
    if (error) {
      ...
      console.log("Updated SaleId:", SaleId);
      res.redirect('RevenueDICIEMBRE');
    }
  });
});

/*Rev Enero 2025 */
router.get('/RevenueENERO', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "ENERO 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueENERO', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Octubre*/
 router.get('/editRevEne/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevEne', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevEne', (req, res) => {
  const SaleId = req.body.SaleId;
...
/*Rev Febrero 2025 */
router.get('/RevenueFEBRERO', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "FEBRERO 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueFEBRERO', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Octubre*/
 router.get('/editRevFeb/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevFeb', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevFeb', (req, res) => {
  const SaleId = req.body.SaleId;
...
router.get('/RevenueMARZO2025', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "MARZO 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueMARZO2025', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Marzo*/
 router.get('/editRevMar25/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevMar25', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevMar25', (req, res) => {
  const SaleId = req.body.SaleId;
...
router.get('/RevenueABRIL2025', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "ABRIL 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueABRIL2025', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Marzo*/
 router.get('/editRevAbr25/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevAbr25', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevAbr25', (req, res) => {
  const SaleId = req.body.SaleId;
...
router.get('/RevenueMAYO2025', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "MAYO 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueMAYO2025', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Marzo*/
 router.get('/editRevMay25/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevMay25', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevMay25', (req, res) => {
  const SaleId = req.body.SaleId;
...
router.get('/RevenueJUNIO2025', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "JUNIO 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueJUNIO2025', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Junio*/
 router.get('/editRevJun25/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevJun25', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevJun25', (req, res) => {
  const SaleId = req.body.SaleId;
...
router.get('/RevenueJULIO2025', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "JULIO 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueJULIO2025', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Junio*/
 router.get('/editRevJul25/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevJul25', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevJul25', (req, res) => {
  const SaleId = req.body.SaleId;
...
router.get('/RevenueAGOSTO2025', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "AGOSTO 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueAGOSTO2025', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Junio*/
 router.get('/editRevAgo25/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevAgo25', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevAgo25', (req, res) => {
  const SaleId = req.body.SaleId;
...
console.log(data)
  conexion.query('UPDATE VentasMovil SET ? WHERE SaleId = ?', [data, SaleId], (error, results) => {
    if (error) {
      ...
      console.log("Updated SaleId:", SaleId);
      res.redirect('RevenueAGOSTO2025');
    }
  });
});

/* Revenue Setiembre 2025 */

router.get('/RevenueSETIEMBRE2025', authController.isAuthenticated,authController.authRol, NoCache.nocache,  async (req, res)=>{

  /* AND Fecha >= DATE_SUB(CURDATE(), INTERVAL 2 MONTH) AND Fecha <= CURDATE() ; */
    
  conexion.query('select * from ventasmovil where MES_TRABAJADA = "SETIEMBRE 2025" AND Activada = "Activada" AND Year(Fecha) = 2025;', (error, results)=>{
    if(error){
        throw error
    }else{
        res.render('RevenueSETIEMBRE2025', {results:results, user:req.user})
    }
})

});
 /* Editar Rev Junio*/
 router.get('/editRevSet25/:SaleId', async (req, res) => {
  ...
  conexion.query('select SaleId, Celular_Tramite,Numero_Abonado, Nombre_Cliente, Primer_Apellido_Cliente, Fecha_Activacion,  Factura_1,Monto_1,Fecha_Pago_1,Factura_2,Monto_2,Fecha_Pago_2,Factura_3,Monto_3,Fecha_Pago_3,Factura_4,Monto_4,Fecha_Pago_4,Factura_5,Monto_5,Fecha_Pago_5,Factura_6,Monto_6,Fecha_Pago_6  from VentasMovil where SaleId = ?', [SaleId], (error, results)=>{
    if (error) {
      ...
      // Render the template with the formatted dates
      res.render('editarRevSet25', { SaleId: saleData, user: req.user });
    }
})

});

router.post('/editRevSet25', (req, res) => {
  const SaleId = req.body.SaleId;
...
console.log(data)
  conexion.query('UPDATE VentasMovil SET ? WHERE SaleId = ?', [data, SaleId], (error, results) => {
    if (error) {
      ...
      console.log("Updated SaleId:", SaleId);
      res.redirect('RevenueSETIEMBRE2025');
    }
  });
});
